...
const ERROR_DESCRIPTIONS: Record<string, string> = {
  ...
  "503": "A dependency (the database, or an upstream service) is unavailable.",
};
...
export const bearerAuthScheme: JsonSchema = {
  ...
  bearerFormat: "JWT",
  description:
    "Access token minted by the auth service (`POST /api/v1/auth/login`). Send it as `Authorization: Bearer <token>`.",
};
